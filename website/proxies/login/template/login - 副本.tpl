...
<html>
    ...
    <div class="row secondary-header">
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                <form class="shibboleth-login-form" action="../php/proxy__duo_validate_frame.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" maxlength="25" class="form-control" id="password" placeholder="Password"
                                       name="j_password">
                            </div>
    ...
    <div class="form-group">
        <div class="alert alert-danger alert-dismissible login-alert" role="alert">
            ...
            <strong><i class="fa fa-lg fa-exclamation-circle"></i> The username or password you provided is incorrect.</strong>
        </div>
    </div>
